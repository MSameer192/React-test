...
export const modalSlice = createSlice({
    ...
    reducers: {
        ...
        openDltModal: (state, action) => {
            const {title, bodyType, extraObject, size} = action.payload
            state.isOpenDltModal = true
            state.bodyType = bodyType
            state.title = title
            state.size = size || 'md'
            state.extraObject = extraObject
        ...
        closeDltModal: (state, action) => {
            state.isOpenDltModal = false
            state.bodyType = ""
            state.title = ""
            state.extraObject = {}
        },
...
export const { openModal, closeModal, openDltModal, closeDltModal } = modalSlice.actions
